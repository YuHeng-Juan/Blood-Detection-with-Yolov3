...
class YOLO(object):
    _defaults = {
        ...
        "classes_path": 'model_data/voc_classes.txt', #指定自定義標籤檔路徑及名稱
...
if __name__ == '__main__':
    t0 = timer()
    yolo=YOLO() #進行YOLO初始化
    path = 'C:/Users/123/OpenVINO_RealSense_HarvestBot/my_yolo3/VOC2007/JPEGImages/noise_image-111.jpg' #指定待測影像檔案路徑及名稱
    try:
        t1 = timer()
